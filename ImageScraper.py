...
# Step 4 : Download the same chrome driver from here  " https://chromedriver.storage.googleapis.com/index.html " make sure to mach atleast first two digits
# Step 5 : put it inside the same folder of this code


DRIVER_PATH = './chromedriver.exe' # Give the same name with which you saved
search_term = 'flight'  # Specify the image to be scraped.
